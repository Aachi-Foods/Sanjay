...
export const metadata: Metadata = {
  title: "Services",
  description:
    "Full-service event planning from BNR Event Planner — invitation design, event planning, venue selection, decoration & design, photography & videography, catering & beverages, entertainment, guest management, and logistics & support.",
};
  ...
  return (
    <>
      <PageHeader
        ...
        description="Nine services, one standard of care. Point at any card to open its full details."
